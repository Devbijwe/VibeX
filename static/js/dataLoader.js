...
function searchLoader() {
    ...
    <div class="modal-header">
        <div class="my-3">
            <input class="form-control me-2 d-flex" style="width:100%;" type="search" id="inputSearch"  placeholder="Search" aria-label="Search">
        </div>
        <button type="button" id="closeBtn2" class="btn-close" data-bs-dismiss="modal" aria-label="Close" ></button>
    </div>
<div class="modal-body">
    <div class="container m-2" style="background:rgb(119, 186, 18);border:2px solid rgb(246, 5, 5)">
